...
def get_erased_mechanisms_from_DEM(dem:stim.DetectorErrorModel, p_cutoff = 0.02):
    ...
    # Q - does the num_detectors set the shape of the H_DEM or do the actual error mechanisms?
